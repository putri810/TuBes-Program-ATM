...
int main(){
	...
	int fGopay=81987654321;
	int fGopay1=83876543210;
	int fGopay2=89123456789; 
	TabInt Tab1, Tab2;
...
if (a5=='1'){
system ("cls");
printf ("SILAKAN MASUKAN NOMOR TELEPON ANDA	: 301341"); scanf ("%d", &NoTelp);
if (NoTelp==fGopay){
system("cls");
...
system ("cls");
printf ("SILAKAN MASUKAN NOMOR TELEPON ANDA	: 301342"); scanf ("%d", &NoTelp);
if (NoTelp==fGopay1){
system("cls");
printf("SILAKAN MASUKKAN JUMLAH GOPAY YANG INGI DIISII:"); scanf("%d", &N);
system("cls");
